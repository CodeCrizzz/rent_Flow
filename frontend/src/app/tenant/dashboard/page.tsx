...
export default function TenantDashboard() {
    ...
    return (
        <div className="max-w-6xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            {/* Header Area */}
            <div>
                <h1 className="text-3xl font-black text-slate-900 dark:text-white tracking-tight transition-colors">Dashboard</h1>
                <p className="text-slate-500 dark:text-slate-400 font-medium mt-1">Hello, {userName.split(' ')[0]}! Real-time overview of your stay.</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                
                {/* Card 1*/}
                <div className="bg-white dark:bg-[#0a0a0c]/80 p-8 border border-slate-200/50 dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none rounded-4xl hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(16,185,129,0.08)] dark:hover:border-emerald-500/30 transition-all duration-300 flex flex-col justify-between group md:col-span-2 lg:col-span-1 relative overflow-hidden">
                    <div className="flex justify-between items-start mb-8">
                        <div className="w-14 h-14 rounded-2xl bg-emerald-50 dark:bg-emerald-500/10 flex items-center justify-center text-emerald-600 dark:text-emerald-400 group-hover:bg-emerald-600 group-hover:text-white group-hover:scale-110 transition-all duration-300 shadow-sm dark:shadow-none border border-emerald-100 dark:border-emerald-500/20 group-hover:border-transparent group-hover:shadow-emerald-500/30">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400 mb-1">Current Balance</h3>
                        <p className="text-5xl font-black text-slate-900 dark:text-white tracking-tight mb-4 transition-all duration-700">₱ {Number(tenantData.balanceDue).toLocaleString()}</p>
                ...
                {/* Card 2 */}
                <div className="bg-white dark:bg-[#0a0a0c]/80 p-8 border border-slate-200/50 dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none rounded-4xl hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(139,92,246,0.08)] dark:hover:border-violet-500/30 transition-all duration-300 flex flex-col justify-between group">
                    <div className="flex justify-between items-start mb-8">
                        <div className="w-14 h-14 rounded-2xl bg-violet-50 dark:bg-violet-500/10 flex items-center justify-center text-violet-600 dark:text-violet-400 group-hover:bg-violet-600 group-hover:text-white group-hover:scale-110 transition-all duration-300 shadow-sm dark:shadow-none border border-violet-100 dark:border-violet-500/20 group-hover:border-transparent group-hover:shadow-violet-500/30">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400 mb-1">Accommodation</h3>
                        <p className="text-3xl font-black text-slate-900 dark:text-white tracking-tight transition-colors">Pending</p>
                        <p className="text-sm text-slate-400 dark:text-slate-500 mt-2 font-medium">The admin will assign your room shortly.</p>
                    </div>
                </div>

                {/* Card 3 */}
                <div className="bg-white dark:bg-[#0a0a0c]/80 p-8 border border-slate-200/50 dark:border-white/5 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-none rounded-4xl hover:-translate-y-1 hover:shadow-[0_8px_30px_rgb(6,182,212,0.08)] dark:hover:border-cyan-500/30 transition-all duration-300 flex flex-col justify-between group">
                    <div className="flex justify-between items-start mb-8">
                        <div className="w-14 h-14 rounded-2xl bg-cyan-50 dark:bg-cyan-500/10 flex items-center justify-center text-cyan-600 dark:text-cyan-400 group-hover:bg-cyan-500 group-hover:text-white group-hover:scale-110 transition-all duration-300 shadow-sm dark:shadow-none border border-cyan-100 dark:border-cyan-500/20 group-hover:border-transparent group-hover:shadow-cyan-500/30">
                    ...
                    <div>
                        <h3 className="text-sm font-bold text-slate-500 dark:text-slate-400 mb-1">Recent Messages</h3>
                        <p className="text-3xl font-black text-slate-900 dark:text-white tracking-tight transition-colors">All Clear</p>
                        <Link href="/tenant/chat" className="inline-block mt-4 text-sm font-bold text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition-colors">
                            Contact Admin →
                        </Link>
                    </div>
                </div>
