...
export default function TenantDashboard() {
    ...
    // NEW: State to trigger the smooth entrance animation
    const [isVisible, setIsVisible] = useState(false);

    useEffect(() => {
        setIsMounted(true);
        // Trigger the entrance animation slightly after mount for a smooth effect
    ...
    return (
        <div className="w-full text-neutral-900 dark:text-neutral-100 font-sans flex flex-col pb-20 bg-transparent overflow-hidden">
            
            <div className="max-w-6xl mx-auto w-full space-y-8 pt-6">
                ...
                {/* --- BENTO GRID LAYOUT (Animates Second - slight delay) --- */}
                <div className={`grid grid-cols-1 lg:grid-cols-12 gap-6 transition-all duration-700 ease-out delay-150 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    ...
                    <div className="lg:col-span-8 bg-white dark:bg-[#121212] rounded-3xl p-8 sm:p-10 border border-neutral-200 dark:border-white/5 shadow-sm flex flex-col justify-between relative overflow-hidden">
                            ...
                            {payStatus ? (
                                ...
                                <button 
                                    ...
                                    className={`w-full sm:w-auto px-8 py-3.5 font-semibold rounded-2xl transition-all duration-200 flex items-center justify-center gap-2 ${
                                        ...
                                        tenantData.balanceDue === 0 ? 'bg-neutral-50 dark:bg-neutral-800/50 text-neutral-400 cursor-not-allowed border border-neutral-200 dark:border-transparent' :
                    ...
                    <div className="lg:col-span-4 flex flex-col gap-6">
                        ...
                        {/* Status Card */}
                        <div className="bg-white dark:bg-[#121212] p-6 rounded-3xl border border-neutral-200 dark:border-white/5 shadow-sm flex-1 flex flex-col justify-center">
                        ...
                        {/* Messages Card */}
                        <div className="bg-white dark:bg-[#121212] p-6 rounded-3xl border border-neutral-200 dark:border-white/5 shadow-sm flex-1 flex flex-col justify-center hover:border-indigo-200 dark:hover:bg-[#181818] cursor-pointer group transition-colors duration-300">
                            <div className="flex items-center justify-between mb-4">
                            ...
                            <div>
                                ...
                                <Link href="/tenant/chat" className="inline-flex items-center text-sm font-medium text-indigo-600 dark:text-indigo-400 group-hover:text-indigo-700 dark:group-hover:text-indigo-300">
                ...
                {/* --- TRANSACTIONS SECTION (Animates Third - longest delay) --- */}
                <div className={`bg-white dark:bg-[#121212] rounded-3xl border border-neutral-200 dark:border-white/5 shadow-sm overflow-hidden transition-all duration-700 ease-out delay-300 transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                    <div className="p-6 sm:px-8 border-b border-neutral-100 dark:border-white/5 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                        ...
                        <button className="self-start sm:self-auto px-4 py-2 bg-neutral-50 dark:bg-neutral-800/50 hover:bg-neutral-100 dark:hover:bg-neutral-800 text-neutral-700 dark:text-neutral-300 rounded-xl border border-neutral-200 dark:border-transparent text-sm font-medium flex items-center gap-2 transition-colors">
