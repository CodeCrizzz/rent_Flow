    ...
    return (
        <SidebarProvider>
            <div className="flex h-screen w-full bg-slate-50 dark:bg-zinc-950 text-slate-900 dark:text-zinc-50 overflow-hidden selection:bg-indigo-500/30">
                {/* --- SHADCN SIDEBAR --- */}
                <Sidebar variant="inset" collapsible="icon" className="border-r border-slate-200/60 dark:border-white/5 bg-white dark:bg-zinc-950 backdrop-blur-3xl shadow-[4px_0_24px_rgba(0,0,0,0.02)] dark:shadow-[4px_0_24px_rgba(0,0,0,0.2)]">
                    <SidebarHeader className="p-5 flex items-center justify-between border-b border-transparent group-data-[collapsible=icon]:p-3 transition-all duration-300">
                        <Link href="/admin/dashboard" className="flex items-center gap-3 overflow-hidden group">
                            ...
                            <span className="text-xl font-black tracking-tight whitespace-nowrap group-data-[collapsible=icon]:hidden">
                                Stay<span className="text-indigo-600 dark:text-indigo-400">Track</span>
                            </span>
                        </Link>
                    </SidebarHeader>
                    ...
                    <SidebarFooter className="p-4 border-t border-slate-200/60 dark:border-white/5 group-data-[collapsible=icon]:p-2 group-data-[collapsible=icon]:items-center bg-white dark:bg-zinc-950 backdrop-blur-md">
                ...
                <SidebarInset className="flex-1 flex flex-col relative w-full h-[100dvh] overflow-hidden bg-transparent">
                    {/* Modern Top Header */}
                    <header className="flex h-16 shrink-0 items-center justify-between gap-4 border-b border-slate-200/60 dark:border-white/5 bg-white dark:bg-zinc-950 backdrop-blur-2xl px-4 sm:px-6 lg:px-8 sticky top-0 z-20 shadow-[0_4px_30px_rgba(0,0,0,0.02)] dark:shadow-[0_4px_30px_rgba(0,0,0,0.2)]">
                    ...
                    <div className="flex-1 flex flex-col overflow-y-auto overflow-x-hidden scrollbar-thin scrollbar-thumb-slate-300 dark:scrollbar-thumb-zinc-700">
                        ...
                        <div className="px-3 py-4 md:px-4 md:py-6 lg:px-5 lg:py-6">
