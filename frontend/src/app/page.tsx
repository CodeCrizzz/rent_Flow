        ...
        >
            ...
            <main className={`relative z-10 flex-1 flex flex-col items-center justify-center px-6 text-center transition-all duration-1000 -mt-24 ${isEntering ? 'opacity-0 scale-95 blur-xl' : 'opacity-100 scale-100 blur-0'}`}>
                ...
                <div className="animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-700">
                    <button onClick={handleEnterPortal} className="relative group inline-flex items-center justify-center px-12 py-5 bg-white text-black font-black text-xs uppercase tracking-[0.2em] rounded-full overflow-hidden transition-all duration-300 hover:scale-105 active:scale-95 shadow-[0_0_40px_rgba(255,255,255,0.1)]">
                        ...
                        <span className="relative z-10 flex items-center gap-3">
                            Enter Portal
                            <svg className="w-4 h-4 transition-transform duration-300 group-hover:translate-x-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
                        </span>
                    </button>
                </div>
            </main>
            ...
            {isEntering && (
                <div className="fixed inset-0 z-[100] flex flex-col items-center justify-center bg-[#050505]/60 backdrop-blur-3xl animate-in fade-in duration-700">
                    ...
                    <p className="text-[10px] font-bold text-indigo-400 uppercase tracking-[0.5em] animate-pulse">Establishing Secure Bridge</p>
