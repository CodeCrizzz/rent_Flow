                ...
                <div className={`w-full md:w-5/12 bg-[#0a0a0a] p-8 sm:p-10 lg:p-14 flex flex-col justify-between relative overflow-hidden border-b md:border-b-0 md:border-r border-white/5 transition-all duration-1000 delay-300 ${isMounted ? 'translate-x-0 opacity-100' : '-translate-x-full opacity-0'}`}>
                    ...
                    <div className="relative z-10 mt-auto">
                        <div className={`transition-all duration-300 ${isSwitching ? 'opacity-0 translate-y-2' : 'opacity-100 translate-y-0'}`}>
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-2 sm:mb-4 leading-tight">{selectedRole === 'tenant' ? "Manage your stay" : "Manage your property"}<br className="hidden sm:block" /> with ease.</h2>
                        </div>
                        <p className="text-zinc-500 text-xs sm:text-sm leading-relaxed max-w-xs">Secure access to the RentFlow ecosystem.</p>
                    </div>
                </div>
                ...
                <div className={`w-full md:w-7/12 p-6 sm:p-10 lg:p-14 bg-zinc-950 flex flex-col justify-center transition-all duration-1000 delay-500 ${isMounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                    ...
                    <div className={`transition-all duration-300 ${isSwitching ? 'opacity-0 scale-[0.98] blur-sm' : 'opacity-100 scale-100 blur-0'}`}>
                        <div className="mb-6 sm:mb-8 text-center md:text-left">
                            <h2 className="text-2xl sm:text-3xl font-bold text-white tracking-tight mb-1 sm:mb-2">{selectedRole === 'tenant' ? 'Welcome to RentFlow' : 'Admin Access'}</h2>
                            <p className="text-zinc-500 text-xs sm:text-sm">Please enter your account credentials.</p>
                        </div>
                        ...
                        <form onSubmit={handleLogin} className="space-y-4 sm:space-y-5">
                            ...
                            <div>
                                <div className="flex justify-between items-center mb-1.5 sm:mb-2 ml-1 pr-1">
                                    <label className="block text-[10px] sm:text-xs font-bold text-zinc-500 uppercase tracking-widest">Password</label>
                                    <Link href="#" className="text-[10px] sm:text-xs font-bold text-zinc-500 hover:text-white transition-colors">Forgot?</Link>
                                </div>
